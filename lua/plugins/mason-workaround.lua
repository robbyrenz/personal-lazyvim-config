...
-- By-passing the changes in this file, as Folke came back, and merged the aforementioned PR:
--   * https://github.com/LazyVim/LazyVim/pull/6053#issuecomment-3290687150
--   * https://github.com/LazyVim/LazyVim/pull/6053#issuecomment-3291400147
if true then
  return {}
end
